...
st.set_page_config("About Latin Morph!")

st.markdown("""
            # About Latin Morph!
                        
            Latin Morph! is developed by [Darcy Krasne](https://www.darcykrasne.com/). It is intended for use by Latin students of all levels.
